...
var Users = /** @class */ (function () {
    ...
    Users.prototype.followersV2 = function (userResolvable_1) {
        return __awaiter(this, arguments, void 0, function (userResolvable, offset, limit) {
            var user, userID, handleResponse, response, parsedResponse, followers, nextHref, nextOffset, url, error_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.api.getV2("/users/".concat(userID, "/followers"), { limit: limit, offset: offset })];
                    case 3:
                        response = _a.sent();
                        parsedResponse = handleResponse(response);
                        followers = parsedResponse.collection;
                        nextHref = parsedResponse.next_href;
                        nextOffset = undefined;
                        if (nextHref) {
                            url = new url_1.URL(nextHref);
                            nextOffset = parseInt(url.searchParams.get('offset') || '0', 10);
                        }
                        return [2 /*return*/, { followers: followers, nextOffset: nextOffset }];
                    case 4:
                        error_1 = _a.sent();
